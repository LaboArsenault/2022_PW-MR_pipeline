...
- 2. results_table.R (only works with results in MRres folder, not with sensitivity analyses results. If using 'loop' script, you should bind your MR results before calling results_table.R)
